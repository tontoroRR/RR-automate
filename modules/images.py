...
class HeroImage:
    # Common
    trainer = 'images/heroTrainer.png'
    ...
    # Event
    flicker = 'images/heroFlicker.png'
    ...
    all = [
            trainer,
            jay, trickster,
            gadget, snowflake, mermaid, mari, mari_ALT,
            flicker,
            necro, necro_ALT, zeus, zeus_ALT
          ]
...
class UnitImage:
    ...
    grindstoneMax = 'images/unitGrindstoneMax.png'
    magicCauldron = 'images/unitMagicCauldron.png'
    magicCauldronMax = 'images/unitMagicCauldronMax.png'
    priestess = 'images/unitPriestess.png'
    priestessMax = 'images/unitPriestessMax.png'
    sharpshooter = 'images/unitSharpshooter.png'
    sharpshooterMax = 'images/unitSharpshooterMax.png'
    zealotMax = 'images/unitZealotMax.png'
    rare = [ alchemistMax, chemist, grindstoneMax, magicCauldron, magicCauldronMax, priestess,
            priestessMax, sharpshooter, sharpshooterMax, zealotMax ]

    # Epic
    clown = 'images/unitClown.png'
    crystalMancer = 'images/unitCrystalMancer.png'
    crystalMancerMax = 'images/unitCrystalMancer.png'
    earthElemental = 'images/unitEarthElemental.png'
    ...
    reaper = 'images/unitReaper.png'
    reaperMax = 'images/unitReaperMax.png'
    epic = [ clown, crystalMancer, crystalMancerMax, earthElemental, engineerMax,
            mime, portalKeeper, portalMageMax, reaper, reaperMax]

    # Legendary
    banshee = 'images/unitBanshee.png'
    bansheeMax = 'images/unitBansheeMax.png'
    bladeDancer = 'images/unitBladeDancer.png'
    bladeDancerMax = 'images/unitBladeDancerMax.png'
    boreas = 'images/unitBoreas.png'
    bruiser = 'images/unitBruiser.png'
    ...
    sword = 'images/unitSword.png'
    sword_ALT = 'images/unitSword_ALT_.png'
    ...
    legendary = [
            banshee, bansheeMax, bladeDancer, bladeDancerMax, boreas,
            # boreasMax,
            bruiser, bruiserMax, clock, clock_ALT, corsair, cultist, cultistMax,
            demonHunter, demonHunterMax, demonHunterMax_ALT, demonologist,
            # demonologistMax,
...
class UnitConverter:
    ...
    def convert_img_to_name(_name: str):
        name = _name
        for k, v in UnitConverter.__DICT.items():
